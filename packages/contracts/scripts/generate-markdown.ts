...
// List of deployments that should be included in the generated README
...
const main = async () => {
  // Initialize the markdown string that we'll generate as part of this script
  let md = ``
  md = addline(md, `# Optimistic Ethereum Deployments`)
  ...
  fs.writeFileSync(path.resolve(__dirname, '../deployments/README.md'), md)
}
